...
{
    uvMainAndLM = uvMainAndLM * _OffsetSize.zwzw + _OffsetSize.xyxy;
    ...
    mixedDiffuse.rgb *= SAMPLE_TEXTURE2D(_ColorMap, sampler_ColorMap, uvMainAndLM).rgb;
...
Varyings SplatmapVert(Attributes v)
{
    ...
    #ifndef TERRAIN_SPLAT_BASEPASS
        float2 tempUV = v.texcoord * _OffsetSize.zw + _OffsetSize.xy;
        
        o.uvSplat01.xy = TRANSFORM_TEX(tempUV, _Splat0);
        o.uvSplat01.zw = TRANSFORM_TEX(tempUV, _Splat1);
        o.uvSplat23.xy = TRANSFORM_TEX(tempUV, _Splat2);
        o.uvSplat23.zw = TRANSFORM_TEX(tempUV, _Splat3);
    #endif
